...
/**************************************************************************************
*                                                                                     *
*          CNeutrinoApp -  setup Color Scheme (LOAD THEME)                               *
*                                                                                     *
**************************************************************************************/
void CNeutrinoApp::setupColors_loadtheme(const char * fileName)
{
	CConfigFile themefile (',', true);
	...
	g_settings.menu_Head_blue  = themefile.getInt32("menu_Head_blue"  , 50);

	g_settings.menu_Head_Text_alpha = themefile.getInt32("menu_Head_Text_alpha"  , 50);
	g_settings.menu_Head_Text_red   = themefile.getInt32("menu_Head_Text_red"  , 95);
	...
	g_settings.menu_Content_red   = themefile.getInt32("menu_Content_red", 0);
	g_settings.menu_Content_green = themefile.getInt32("menu_Content_green", 0);
	g_settings.menu_Content_blue  = themefile.getInt32("menu_Content_blue", 20);

	g_settings.menu_Content_Text_alpha = themefile.getInt32("menu_Content_Text_alpha", 0);
	g_settings.menu_Content_Text_red   = themefile.getInt32("menu_Content_Text_red", 100);
	g_settings.menu_Content_Text_green = themefile.getInt32("menu_Content_Text_green", 100);
	g_settings.menu_Content_Text_blue  = themefile.getInt32("menu_Content_Text_blue", 100);

	g_settings.menu_Content_Selected_alpha = themefile.getInt32("menu_Content_Selected_alpha", 0);15;
	g_settings.menu_Content_Selected_red   = themefile.getInt32("menu_Content_Selected_red", 0);0;
	g_settings.menu_Content_Selected_green = themefile.getInt32("menu_Content_Selected_green", 0);65;
	g_settings.menu_Content_Selected_blue  = themefile.getInt32("menu_Content_Selected_blue", 0);0;

	g_settings.menu_Content_Selected_Text_alpha  = themefile.getInt32("menu_Content_Selected_Text_alpha", 0);0;
	g_settings.menu_Content_Selected_Text_red    = themefile.getInt32("menu_Content_Selected_Text_red", 0);0;
	g_settings.menu_Content_Selected_Text_green  = themefile.getInt32("menu_Content_Selected_Text_green", 0);0;
	g_settings.menu_Content_Selected_Text_blue   = themefile.getInt32("menu_Content_Selected_Text_blue", 0);0;

	g_settings.menu_Content_inactive_alpha = themefile.getInt32("menu_Content_inactive_alpha", 0);20;
	g_settings.menu_Content_inactive_red   = themefile.getInt32("menu_Content_inactive_red", 0);0;
	g_settings.menu_Content_inactive_green = themefile.getInt32("menu_Content_inactive_green", 0);0;
	g_settings.menu_Content_inactive_blue  = themefile.getInt32("menu_Content_inactive_blue", 0);15;

	g_settings.menu_Content_inactive_Text_alpha  = themefile.getInt32("menu_Content_inactive_blue", 0);0;
	g_settings.menu_Content_inactive_Text_red    = themefile.getInt32("menu_Content_inactive_Text_red", 0);55;
	g_settings.menu_Content_inactive_Text_green  = themefile.getInt32("menu_Content_inactive_Text_green", 0);70;
	g_settings.menu_Content_inactive_Text_blue   = themefile.getInt32("menu_Content_inactive_Text_blue", 0);85;
	...
	g_settings.infobar_blue  = themefile.getInt32("infobar_blue", 20);

	g_settings.infobar_Text_alpha = themefile.getInt32("infobar_Text_alpha", 0);0;
...
int CNeutrinoApp::loadSetup(const char * fname)
{
	...
	g_settings.hue = configfile.getInt32("video_hue", 0);
	g_settings.saturation = configfile.getInt32("video_saturation", 128);
...
//FIXME
	...
	strcpy( g_settings.network_nfs_recordingdir, configfile.getString( "network_nfs_recordingdir", "/media/sda1/movie" ).c_str() );
...
//		unlink("/tmp/.reboot");
		...
		setupColors_loadtheme(THEMESDIR "/neutrino.cfg");
		colorSetupNotifier->changeNotify(NONEXISTANT_LOCALE, NULL);
	}
	else if (actionKey=="theme_classic") {
		setupColors_loadtheme(THEMESDIR "/classic.cfg");
		colorSetupNotifier->changeNotify(NONEXISTANT_LOCALE, NULL);
	}
	else if (actionKey=="theme_dblue") {
		setupColors_loadtheme(THEMESDIR "/dblue.cfg");
		colorSetupNotifier->changeNotify(NONEXISTANT_LOCALE, NULL);
	}
	else if (actionKey=="theme_dvb2k") {
		setupColors_loadtheme(THEMESDIR "/dvb2k.cfg");
		colorSetupNotifier->changeNotify(NONEXISTANT_LOCALE, NULL);
	}
	else if (actionKey=="theme_newgeneration") {
		setupColors_loadtheme(THEMESDIR "/newgeneration.cfg");
		colorSetupNotifier->changeNotify(NONEXISTANT_LOCALE, NULL);
	}
	else if(actionKey=="theme_ru") {
		setupColors_loadtheme(THEMESDIR "/ru.cfg");
		colorSetupNotifier->changeNotify(NONEXISTANT_LOCALE, NULL);
	}
	else if(actionKey=="theme_red") {
		setupColors_loadtheme(THEMESDIR "/red.cfg");
		colorSetupNotifier->changeNotify(NONEXISTANT_LOCALE, NULL);
	}
