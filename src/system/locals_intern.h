...
const char *locale_real_names[] = {
	...
	"colorthememenu.newgeneration_theme",
	...
	"servicemenu.update",
	"servicemenu.tuner",
	"servicemenu.tuner_dvbs",
	"servicemenu.tuner_dvbc",
	"servicemenu.tuner_dvbt",
	"servicemenu.tuner_options_slot0",
	"servicemenu.tuner_options_slot1",
	"settings.help",
